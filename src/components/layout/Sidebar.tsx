    ...
    <aside className="flex h-full w-64 flex-col border-r border-gray-100 bg-white">
      ...
      <div className="border-b border-gray-100 px-4 py-3">
        <div className="flex items-center gap-3 rounded-xl bg-amber-50 p-3">
          <div
            ...
            style={{ backgroundColor: `${primaryPet.color}20`, borderColor: primaryPet.color }}
          >
            🐕
          </div>
          <div className="flex-1 min-w-0">
            <p className="font-semibold text-gray-900 truncate">{primaryPet.name}</p>
            <p className="text-xs text-gray-500">
              {primaryPet.breed} · {primaryPet.age}y
            </p>
          </div>
          <div className="text-right">
            <p className="text-sm font-bold text-green-600">{primaryPet.healthScore}</p>
      ...
      <nav className="flex-1 overflow-y-auto p-3">
        ...
        <div className="mt-4 border-t border-gray-100 pt-4">
          <button className="flex w-full items-center gap-3 rounded-xl border-2 border-dashed border-gray-200 px-3 py-2.5 text-sm font-medium text-gray-400 transition-all hover:border-green-300 hover:text-green-600">
